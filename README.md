...
The global top three regions account for 42.2% of all prominent figures while the top five account for 59.9%. This dominancy of the podium is emphasized for executives and scholars, representing respectively 49.9% and 61.2% of the total count.
...
**Figure 3** further highlights the Parisian lead. The top ranking cities - Paris, Lyon and Marseille - are the three major cities of the country. However, it is surprising to observe that Neuilly-sur-Seine ([59 200 inhabitants](https://www.insee.fr/fr/statistiques/2011101?geo=COM-92051)) ranks fourth on the global ranking, followed by Boulogne-Billancourt ([120 205 inhabitants](https://www.insee.fr/fr/statistiques/2011101?geo=COM-92012)) and the 16th arrondissement of Paris, in front of Toulouse, the [fourth largest city of the country](https://www.insee.fr/fr/statistiques/2011101?geo=COM-31555). This is substantial for scholars and executives, where Neuilly-sur-Seine and Boulogne-Billancourt produce more individuals than cities like Marseille and Lyon.
...
Last, the links we underline, notably the presence of elites positively correlated with preparatory classes, could be reverse causality: preparatory classes may be established because elites are already present. Future work could use panel data and historical discontinuities (e.g., the creation of preparatory classes) to identify causal effects.
<br><br>
